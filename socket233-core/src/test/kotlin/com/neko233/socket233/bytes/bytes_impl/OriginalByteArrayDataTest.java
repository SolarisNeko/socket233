 ...
 **/
public class OriginalByteArrayDataTest {

    @Test
    public void create() {
        ByteArrayData byteArrayData = OriginalByteArrayData.create(5);
    ...
    public void createCopy() {
        ByteArrayData newEmpty = OriginalByteArrayData.create(10);
    ...
    public void setReadWriteIndex() {
        ...
        // 最大容量
        ByteArrayData newMaxBytes = OriginalByteArrayData.create(10, 10);
        // 超出, 抛异常
    ...
    public void writeNumberAndReadNumber() {
        ByteArrayData bytes = OriginalByteArrayData.create(10);
    ...
    public void writeAtoB() {
        ByteArrayData a = OriginalByteArrayData.create(10);
        ByteArrayData b = OriginalByteArrayData.create(10);
        ...
        b.writeBytesFrom(a);
        Integer integer = b.readInteger();
        Assert.assertEquals(num, (int) integer);
