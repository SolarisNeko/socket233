...
import com.neko233.socket233.impl.tcp.packet.TcpSplitEndMessagePacketHandler;
 ...
 **/
@Slf4j
public class TcpIoChannel implements IoChannel {

    // 粘包分包处理器
    private final MessagePacketHandler messagePacketHandler = new TcpSplitEndMessagePacketHandler();

    // netty 通信 io 上下文
    private final ChannelHandlerContext nettyContext;
    private final InetSocketAddress inetSocketAddress;

    public TcpIoChannel(ChannelHandlerContext nettyContext) {
