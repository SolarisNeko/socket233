...
import com.neko233.socket233.impl.tcp.io.KcpIoChannel;
...
public class KcpTransportLayerHandlerAdapter extends ChannelInboundHandlerAdapter {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        final IoChannel ioChannel = new KcpIoChannel(ctx);
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        String remoteIp = NettyNetworkUtils.getRemoteIp(ctx);
        int remotePort = NettyNetworkUtils.getRemotePort(ctx);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        SessionManager.getInstance().refreshSession(globalSessionId);
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
        log.error("[KcpServer] 未处理异常, 关闭连接", cause);
        ctx.close();
    }
}
